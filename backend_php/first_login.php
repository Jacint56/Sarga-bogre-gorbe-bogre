                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <form method="POST" action="login.php<?php echo "?verification=true"; ?>">
                                            <div class="form-group">
                                                <label for="inputEmail">Email</label>
                                                <input type="email" id="inputEmail" name="inputEmail" placeholder="Email cime">
                                            </div>
                                            <button type="submit" class="btn btn-primary">Megrosites</button>
                                        </form>
                                    </div>
                                    <div class="text-center">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="register.html">Regisztráljon most!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
